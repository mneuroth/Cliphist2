...
public:
    EditItem(QWidget *parent = 0, const QFont & aFont = QFont(), const QPalette & aPalette = QPalette(), const QString & sText = "", const QPixmap * pImage = 0, const QColor & aCurrentColor = tr("red"), int iCurrentWidth = 5);
